...
(function() {
  var Bullet, DRAG, GAMMA, GaussRNG, HEIGHT, LOG_10, MAX_DBEARING, MAX_FIRE_POWER, MAX_ITERATIONS, MAX_SENSOR_NOISE, MAX_SPEED, MAX_SPEED2, MIN_FIRE_POWER, MUZZLE_SPEED, Obstacle, Renderer, Tank, WIDTH, limit, rand, root;
  ...
  root.tanktastic.Game = (function() {
    ...
    Game.prototype.build_obstacles = function() {
      ...
      while (this.obstacles.length < num) {
        this.obstacles.push(new Obstacle(rand(30, 80), rand(WIDTH / 2 - 200, 400), rand(HEIGHT / 2 - 80, 160)));
      }
