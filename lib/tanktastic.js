...
(function() {
  var Bullet, DRAG, GAMMA, GaussRNG, HEIGHT, LOG_10, MAX_FIRE_POWER, MAX_FORCE, MAX_FORCE2, MAX_ITERATIONS, MAX_SPEED, MAX_SPEED2, MIN_FIRE_POWER, MUZZLE_SPEED, Obstacle, Renderer, Tank, WIDTH, limit, rand, root, unNaN;
  ...
  root.tanktastic.Game = (function() {
    ...
    Game.prototype.init = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        tank = _ref[_i];
        _results.push(tank.init(tank.to_state(this.radar(tank, this.tanks), this.obstacle_state())[0]));
      }
      return _results;
    };

    Game.prototype.step = function(discrete) {
      var dt, now, tank, tanks, _i, _j, _len, _len1, _ref;
      if (discrete == null) {
        discrete = false;
      }
    ...
    Game.prototype.integrate = function(tanks) {
      var bullet, f, speed, tank, _i, _j, _len, _len1, _ref, _results;
      _ref = this.bullets;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        bullet = _ref[_i];
    ...
    Game.prototype.fire = function(tanks) {
      ...
      for (_i = 0, _len = tanks.length; _i < _len; _i++) {
        tank = tanks[_i];
        if (tank.gun_heat <= 0 && tank.fire_command >= MIN_FIRE_POWER) {
  ...
  Tank = (function() {
    ...
    Tank.prototype.init = function(state) {
      if (this.init_target) {
        return this.init_target(state);
      }
    };
    ...
    Tank.prototype.step = function(dt, radar, obstacles) {
      ...
      this.step_target(dt, state, controller);
      return this.ticks++;
    };
    ...
    Tank.prototype.to_state = function(radar, obstacles) {
      var controller, state, tank,
        _this = this;
      this.fx = this.fy = this.dbearing = this.fire_command = 0.0;
      tank = this;
      controller = {
        ...
        exert: function(fx, fy) {
          tank.fx += unNaN(fx);
          return tank.fy += unNaN(fy);
        },
        fire: function(power) {
          return tank.fire_command = limit(unNaN(power), MIN_FIRE_POWER, MAX_FIRE_POWER);
        },
        aim_at: function(x, y) {
          return tank.bearing = Math.atan2(unNaN(y) - _this.y, unNaN(x) - _this.x);
        }
      };
      state = {
        x: this.x,
