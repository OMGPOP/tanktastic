...
(function() {
  ...
  Tournament = (function() {
    ...
    Tournament.prototype.print_results = function() {
      var i, k, longest, output, player, results, v, _i, _j, _len, _len1, _ref;
      output = "\n  Results:\n\n";
      results = [];
      _ref = this.players;
      for (k in _ref) {
    ...
    Tournament.prototype.add_cell = function(len, value) {
      return "| " + this.add_tabular(len, value.toString(), " ");
    };

    Tournament.prototype.add_line = function(len, cols, spacer) {
      var i;
      if (spacer == null) {
        spacer = "-";
      }
    ...
    Tournament.prototype.add_tabular = function(len, value, spacer) {
      var i;
      return value + ((function() {
        var _i, _ref, _results;
        _results = [];
